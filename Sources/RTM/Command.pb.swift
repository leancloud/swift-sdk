...
enum IMDeviceType: SwiftProtobuf.Enum {
  typealias RawValue = Int
  case unknown // = 0
  case android // = 1
  case ios // = 2
...
extension IMDeviceType: CaseIterable {
  // Support synthesized by the compiler.
}

#endif  // swift(>=4.2)

struct IMSemanticVersion {
  ...
  var hasPreRelease: Bool {return self._preRelease != nil}
  /// Clears the value of `preRelease`. Subsequent reads from it will return its default value.
  mutating func clearPreRelease() {self._preRelease = nil}
...
struct IMAndroidVersion {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var codename: String {
    get {return _codename ?? String()}
    set {_codename = newValue}
  }
  /// Returns true if `codename` has been explicitly set.
  var hasCodename: Bool {return self._codename != nil}
  /// Clears the value of `codename`. Subsequent reads from it will return its default value.
  mutating func clearCodename() {self._codename = nil}

  var apiLevel: String {
    get {return _apiLevel ?? String()}
  ...
  fileprivate var _codename: String? = nil
  fileprivate var _apiLevel: String? = nil
}
...
struct IMSystemInfo {
  ...
  var osVersion: IMSemanticVersion {
    get {return _osVersion ?? IMSemanticVersion()}
  ...
  var androidVersion: IMAndroidVersion {
    get {return _androidVersion ?? IMAndroidVersion()}
  ...
  var isEmulator: Bool {
    get {return _isEmulator ?? false}
    set {_isEmulator = newValue}
  }
  /// Returns true if `isEmulator` has been explicitly set.
  var hasIsEmulator: Bool {return self._isEmulator != nil}
  /// Clears the value of `isEmulator`. Subsequent reads from it will return its default value.
  mutating func clearIsEmulator() {self._isEmulator = nil}

  var unknownFields = SwiftProtobuf.UnknownStorage()

  init() {}

  fileprivate var _deviceType: IMDeviceType? = nil
  fileprivate var _osVersion: IMSemanticVersion? = nil
  fileprivate var _androidVersion: IMAndroidVersion? = nil
  fileprivate var _isEmulator: Bool? = nil
}
...
struct IMLoginCommand {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var systemInfo: IMSystemInfo {
    get {return _systemInfo ?? IMSystemInfo()}
  ...
  fileprivate var _systemInfo: IMSystemInfo? = nil
}

struct IMLoggedinCommand {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var pushDisabled: Bool {
    get {return _pushDisabled ?? false}
    set {_pushDisabled = newValue}
  }
  /// Returns true if `pushDisabled` has been explicitly set.
  var hasPushDisabled: Bool {return self._pushDisabled != nil}
  /// Clears the value of `pushDisabled`. Subsequent reads from it will return its default value.
  mutating func clearPushDisabled() {self._pushDisabled = nil}

  var unknownFields = SwiftProtobuf.UnknownStorage()

  init() {}

  fileprivate var _pushDisabled: Bool? = nil
}
...
struct IMSessionCommand {
  ...
  var systemInfo: IMSystemInfo {
    get {return _storage._systemInfo ?? IMSystemInfo()}
...
struct IMDirectCommand {
  ...
  var binaryMsg: Data {
    get {return _storage._binaryMsg ?? Data()}
...
struct IMConvCommand {
  ...
  var existing: Bool {
    get {return _storage._existing ?? false}
    set {_uniqueStorage()._existing = newValue}
  }
  /// Returns true if `existing` has been explicitly set.
  var hasExisting: Bool {return _storage._existing != nil}
  /// Clears the value of `existing`. Subsequent reads from it will return its default value.
  mutating func clearExisting() {_uniqueStorage()._existing = nil}
...
struct IMPubsubCommand {
  ...
  var subtopic: String {
    get {return _subtopic ?? String()}
    set {_subtopic = newValue}
  }
  /// Returns true if `subtopic` has been explicitly set.
  var hasSubtopic: Bool {return self._subtopic != nil}
  /// Clears the value of `subtopic`. Subsequent reads from it will return its default value.
  mutating func clearSubtopic() {self._subtopic = nil}
  ...
  var results: IMJsonObjectMessage {
    get {return _results ?? IMJsonObjectMessage()}
  ...
  fileprivate var _subtopic: String? = nil
  fileprivate var _results: IMJsonObjectMessage? = nil
}
...
struct IMGenericCommand {
  ...
  var loginMessage: IMLoginCommand {
    get {return _storage._loginMessage ?? IMLoginCommand()}
    set {_uniqueStorage()._loginMessage = newValue}
  }
  /// Returns true if `loginMessage` has been explicitly set.
  var hasLoginMessage: Bool {return _storage._loginMessage != nil}
  /// Clears the value of `loginMessage`. Subsequent reads from it will return its default value.
  mutating func clearLoginMessage() {_uniqueStorage()._loginMessage = nil}
  ...
  var loggedinMessage: IMLoggedinCommand {
    get {return _storage._loggedinMessage ?? IMLoggedinCommand()}
    set {_uniqueStorage()._loggedinMessage = newValue}
  }
  /// Returns true if `loggedinMessage` has been explicitly set.
  var hasLoggedinMessage: Bool {return _storage._loggedinMessage != nil}
  /// Clears the value of `loggedinMessage`. Subsequent reads from it will return its default value.
  mutating func clearLoggedinMessage() {_uniqueStorage()._loggedinMessage = nil}
...
extension IMDeviceType: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension IMSemanticVersion: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try { try decoder.decodeSingularStringField(value: &self._build) }()
      default: break
      }
    }
  }
  ...
  static func ==(lhs: IMSemanticVersion, rhs: IMSemanticVersion) -> Bool {
...
extension IMAndroidVersion: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".AndroidVersion"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "codename"),
    2: .same(proto: "apiLevel"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self._codename) }()
      case 2: try { try decoder.decodeSingularStringField(value: &self._apiLevel) }()
      default: break
      }
    }
  }
  ...
  static func ==(lhs: IMAndroidVersion, rhs: IMAndroidVersion) -> Bool {
    if lhs._codename != rhs._codename {return false}
...
extension IMSystemInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".SystemInfo"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "deviceType"),
    2: .same(proto: "osVersion"),
    3: .same(proto: "androidVersion"),
    4: .same(proto: "isEmulator"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try { try decoder.decodeSingularBoolField(value: &self._isEmulator) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if let v = self._androidVersion {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
    }
    if let v = self._isEmulator {
      try visitor.visitSingularBoolField(value: v, fieldNumber: 4)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: IMSystemInfo, rhs: IMSystemInfo) -> Bool {
    ...
    if lhs._isEmulator != rhs._isEmulator {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension IMUnreadTuple: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self._cid) }()
      case 2: try { try decoder.decodeSingularInt32Field(value: &self._unread) }()
      case 3: try { try decoder.decodeSingularStringField(value: &self._mid) }()
      case 4: try { try decoder.decodeSingularInt64Field(value: &self._timestamp) }()
      case 5: try { try decoder.decodeSingularStringField(value: &self._from) }()
      case 6: try { try decoder.decodeSingularStringField(value: &self._data) }()
      case 7: try { try decoder.decodeSingularInt64Field(value: &self._patchTimestamp) }()
      case 8: try { try decoder.decodeSingularBoolField(value: &self._mentioned) }()
      case 9: try { try decoder.decodeSingularBytesField(value: &self._binaryMsg) }()
      case 10: try { try decoder.decodeSingularInt32Field(value: &self._convType) }()
      default: break
      }
    }
  }
...
extension IMLogItem: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self._from) }()
      ...
      case 4: try { try decoder.decodeSingularStringField(value: &self._msgID) }()
      case 5: try { try decoder.decodeSingularInt64Field(value: &self._ackAt) }()
      case 6: try { try decoder.decodeSingularInt64Field(value: &self._readAt) }()
      case 7: try { try decoder.decodeSingularInt64Field(value: &self._patchTimestamp) }()
      case 8: try { try decoder.decodeSingularBoolField(value: &self._mentionAll) }()
      case 9: try { try decoder.decodeRepeatedStringField(value: &self.mentionPids) }()
      case 10: try { try decoder.decodeSingularBoolField(value: &self._bin) }()
      case 11: try { try decoder.decodeSingularInt32Field(value: &self._convType) }()
      default: break
      }
    }
  }
...
extension IMConvMemberInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self._pid) }()
      case 2: try { try decoder.decodeSingularStringField(value: &self._role) }()
      case 3: try { try decoder.decodeSingularStringField(value: &self._infoID) }()
      default: break
      }
    }
  }
...
extension IMLoginCommand: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".LoginCommand"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "systemInfo"),
  ]
  ...
  static func ==(lhs: IMLoginCommand, rhs: IMLoginCommand) -> Bool {
...
extension IMLoggedinCommand: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".LoggedinCommand"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "pushDisabled"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularBoolField(value: &self._pushDisabled) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if let v = self._pushDisabled {
      try visitor.visitSingularBoolField(value: v, fieldNumber: 1)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: IMLoggedinCommand, rhs: IMLoggedinCommand) -> Bool {
    if lhs._pushDisabled != rhs._pushDisabled {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension IMDataCommand: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeRepeatedMessageField(value: &self.msg) }()
      case 3: try { try decoder.decodeSingularBoolField(value: &self._offline) }()
      default: break
      }
    }
  }
...
extension IMSessionCommand: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _systemInfo: IMSystemInfo? = nil
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        // enabled. https://github.com/apple/swift-protobuf/issues/1034
        switch fieldNumber {
        case 1: try { try decoder.decodeSingularInt64Field(value: &_storage._t) }()
        case 2: try { try decoder.decodeSingularStringField(value: &_storage._n) }()
        case 3: try { try decoder.decodeSingularStringField(value: &_storage._s) }()
        case 4: try { try decoder.decodeSingularStringField(value: &_storage._ua) }()
        case 5: try { try decoder.decodeSingularBoolField(value: &_storage._r) }()
        case 6: try { try decoder.decodeSingularStringField(value: &_storage._tag) }()
        case 7: try { try decoder.decodeSingularStringField(value: &_storage._deviceID) }()
        case 8: try { try decoder.decodeRepeatedStringField(value: &_storage._sessionPeerIds) }()
        case 9: try { try decoder.decodeRepeatedStringField(value: &_storage._onlineSessionPeerIds) }()
        case 10: try { try decoder.decodeSingularStringField(value: &_storage._st) }()
        case 11: try { try decoder.decodeSingularInt32Field(value: &_storage._stTtl) }()
        case 12: try { try decoder.decodeSingularInt32Field(value: &_storage._code) }()
        case 13: try { try decoder.decodeSingularStringField(value: &_storage._reason) }()
        case 14: try { try decoder.decodeSingularStringField(value: &_storage._deviceToken) }()
        case 15: try { try decoder.decodeSingularBoolField(value: &_storage._sp) }()
        case 16: try { try decoder.decodeSingularStringField(value: &_storage._detail) }()
        case 17: try { try decoder.decodeSingularInt64Field(value: &_storage._lastUnreadNotifTime) }()
        case 18: try { try decoder.decodeSingularInt64Field(value: &_storage._lastPatchTime) }()
        case 19: try { try decoder.decodeSingularInt64Field(value: &_storage._configBitmap) }()
        case 20: try { try decoder.decodeSingularMessageField(value: &_storage._systemInfo) }()
        default: break
        }
      }
    }
...
extension IMErrorCommand: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularInt32Field(value: &self._appCode) }()
      case 4: try { try decoder.decodeSingularStringField(value: &self._detail) }()
      case 5: try { try decoder.decodeRepeatedStringField(value: &self.pids) }()
      case 6: try { try decoder.decodeSingularStringField(value: &self._appMsg) }()
      default: break
      }
    }
  }
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        // enabled. https://github.com/apple/swift-protobuf/issues/1034
        switch fieldNumber {
        case 1: try { try decoder.decodeSingularStringField(value: &_storage._msg) }()
        case 2: try { try decoder.decodeSingularStringField(value: &_storage._uid) }()
        case 3: try { try decoder.decodeSingularStringField(value: &_storage._fromPeerID) }()
        case 4: try { try decoder.decodeSingularInt64Field(value: &_storage._timestamp) }()
        case 5: try { try decoder.decodeSingularBoolField(value: &_storage._offline) }()
        case 6: try { try decoder.decodeSingularBoolField(value: &_storage._hasMore_p) }()
        case 7: try { try decoder.decodeRepeatedStringField(value: &_storage._toPeerIds) }()
        case 10: try { try decoder.decodeSingularBoolField(value: &_storage._r) }()
        case 11: try { try decoder.decodeSingularStringField(value: &_storage._cid) }()
        case 12: try { try decoder.decodeSingularStringField(value: &_storage._id) }()
        case 13: try { try decoder.decodeSingularBoolField(value: &_storage._transient) }()
        case 14: try { try decoder.decodeSingularStringField(value: &_storage._dt) }()
        case 15: try { try decoder.decodeSingularStringField(value: &_storage._roomID) }()
        case 16: try { try decoder.decodeSingularStringField(value: &_storage._pushData) }()
        case 17: try { try decoder.decodeSingularBoolField(value: &_storage._will) }()
        case 18: try { try decoder.decodeSingularInt64Field(value: &_storage._patchTimestamp) }()
        case 19: try { try decoder.decodeSingularBytesField(value: &_storage._binaryMsg) }()
        case 20: try { try decoder.decodeRepeatedStringField(value: &_storage._mentionPids) }()
        case 21: try { try decoder.decodeSingularBoolField(value: &_storage._mentionAll) }()
        case 22: try { try decoder.decodeSingularInt32Field(value: &_storage._convType) }()
        default: break
        }
      }
    }
...
extension IMAckCommand: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularStringField(value: &self._reason) }()
      case 3: try { try decoder.decodeSingularStringField(value: &self._mid) }()
      case 4: try { try decoder.decodeSingularStringField(value: &self._cid) }()
      case 5: try { try decoder.decodeSingularInt64Field(value: &self._t) }()
      case 6: try { try decoder.decodeSingularStringField(value: &self._uid) }()
      case 7: try { try decoder.decodeSingularInt64Field(value: &self._fromts) }()
      case 8: try { try decoder.decodeSingularInt64Field(value: &self._tots) }()
      case 9: try { try decoder.decodeSingularStringField(value: &self._type) }()
      case 10: try { try decoder.decodeRepeatedStringField(value: &self.ids) }()
      case 11: try { try decoder.decodeSingularInt32Field(value: &self._appCode) }()
      case 12: try { try decoder.decodeSingularStringField(value: &self._appMsg) }()
      default: break
      }
    }
  }
...
extension IMUnreadCommand: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularInt64Field(value: &self._notifTime) }()
      default: break
      }
    }
  }
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        // enabled. https://github.com/apple/swift-protobuf/issues/1034
        switch fieldNumber {
        case 1: try { try decoder.decodeRepeatedStringField(value: &_storage._m) }()
        case 2: try { try decoder.decodeSingularBoolField(value: &_storage._transient) }()
        case 3: try { try decoder.decodeSingularBoolField(value: &_storage._unique) }()
        case 4: try { try decoder.decodeSingularStringField(value: &_storage._cid) }()
        case 5: try { try decoder.decodeSingularStringField(value: &_storage._cdate) }()
        case 6: try { try decoder.decodeSingularStringField(value: &_storage._initBy) }()
        case 7: try { try decoder.decodeSingularStringField(value: &_storage._sort) }()
        case 8: try { try decoder.decodeSingularInt32Field(value: &_storage._limit) }()
        case 9: try { try decoder.decodeSingularInt32Field(value: &_storage._skip) }()
        case 10: try { try decoder.decodeSingularInt32Field(value: &_storage._flag) }()
        case 11: try { try decoder.decodeSingularInt32Field(value: &_storage._count) }()
        case 12: try { try decoder.decodeSingularStringField(value: &_storage._udate) }()
        case 13: try { try decoder.decodeSingularInt64Field(value: &_storage._t) }()
        case 14: try { try decoder.decodeSingularStringField(value: &_storage._n) }()
        case 15: try { try decoder.decodeSingularStringField(value: &_storage._s) }()
        case 16: try { try decoder.decodeSingularBoolField(value: &_storage._statusSub) }()
        case 17: try { try decoder.decodeSingularBoolField(value: &_storage._statusPub) }()
        case 18: try { try decoder.decodeSingularInt32Field(value: &_storage._statusTtl) }()
        case 19: try { try decoder.decodeSingularStringField(value: &_storage._uniqueID) }()
        case 20: try { try decoder.decodeSingularStringField(value: &_storage._targetClientID) }()
        case 21: try { try decoder.decodeSingularInt64Field(value: &_storage._maxReadTimestamp) }()
        case 22: try { try decoder.decodeSingularInt64Field(value: &_storage._maxAckTimestamp) }()
        case 23: try { try decoder.decodeSingularBoolField(value: &_storage._queryAllMembers) }()
        case 24: try { try decoder.decodeRepeatedMessageField(value: &_storage._maxReadTuples) }()
        case 25: try { try decoder.decodeRepeatedStringField(value: &_storage._cids) }()
        case 26: try { try decoder.decodeSingularMessageField(value: &_storage._info) }()
        case 27: try { try decoder.decodeSingularBoolField(value: &_storage._tempConv) }()
        case 28: try { try decoder.decodeSingularInt32Field(value: &_storage._tempConvTtl) }()
        case 29: try { try decoder.decodeRepeatedStringField(value: &_storage._tempConvIds) }()
        case 30: try { try decoder.decodeRepeatedStringField(value: &_storage._allowedPids) }()
        case 31: try { try decoder.decodeRepeatedMessageField(value: &_storage._failedPids) }()
        case 32: try { try decoder.decodeSingularBoolField(value: &_storage._existing) }()
        case 40: try { try decoder.decodeSingularStringField(value: &_storage._next) }()
        case 100: try { try decoder.decodeSingularMessageField(value: &_storage._results) }()
        case 101: try { try decoder.decodeSingularMessageField(value: &_storage._where) }()
        case 103: try { try decoder.decodeSingularMessageField(value: &_storage._attr) }()
        case 104: try { try decoder.decodeSingularMessageField(value: &_storage._attrModified) }()
        default: break
        }
      }
    }
  ...
  static func ==(lhs: IMConvCommand, rhs: IMConvCommand) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._existing != rhs_storage._existing {return false}
...
extension IMRoomCommand: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularInt64Field(value: &self._t) }()
      case 4: try { try decoder.decodeSingularStringField(value: &self._n) }()
      case 5: try { try decoder.decodeSingularBoolField(value: &self._transient) }()
      case 6: try { try decoder.decodeRepeatedStringField(value: &self.roomPeerIds) }()
      case 7: try { try decoder.decodeSingularStringField(value: &self._byPeerID) }()
      default: break
      }
    }
  }
...
extension IMLogsCommand: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self._cid) }()
      case 2: try { try decoder.decodeSingularInt32Field(value: &self._l) }()
      case 3: try { try decoder.decodeSingularInt32Field(value: &self._limit) }()
      case 4: try { try decoder.decodeSingularInt64Field(value: &self._t) }()
      case 5: try { try decoder.decodeSingularInt64Field(value: &self._tt) }()
      case 6: try { try decoder.decodeSingularStringField(value: &self._tmid) }()
      case 7: try { try decoder.decodeSingularStringField(value: &self._mid) }()
      case 8: try { try decoder.decodeSingularStringField(value: &self._checksum) }()
      case 9: try { try decoder.decodeSingularBoolField(value: &self._stored) }()
      case 10: try { try decoder.decodeSingularEnumField(value: &self._direction) }()
      case 11: try { try decoder.decodeSingularBoolField(value: &self._tIncluded) }()
      case 12: try { try decoder.decodeSingularBoolField(value: &self._ttIncluded) }()
      case 13: try { try decoder.decodeSingularInt32Field(value: &self._lctype) }()
      case 105: try { try decoder.decodeRepeatedMessageField(value: &self.logs) }()
      default: break
      }
    }
  }
...
extension IMRcpCommand: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularStringField(value: &self._cid) }()
      case 3: try { try decoder.decodeSingularInt64Field(value: &self._t) }()
      case 4: try { try decoder.decodeSingularBoolField(value: &self._read) }()
      case 5: try { try decoder.decodeSingularStringField(value: &self._from) }()
      default: break
      }
    }
...
extension IMMaxReadTuple: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self._pid) }()
      case 2: try { try decoder.decodeSingularInt64Field(value: &self._maxAckTimestamp) }()
      case 3: try { try decoder.decodeSingularInt64Field(value: &self._maxReadTimestamp) }()
      default: break
      }
    }
  }
...
extension IMReadCommand: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self._cid) }()
      case 2: try { try decoder.decodeRepeatedStringField(value: &self.cids) }()
      case 3: try { try decoder.decodeRepeatedMessageField(value: &self.convs) }()
      default: break
      }
    }
  }
...
extension IMPresenceCommand: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeRepeatedStringField(value: &self.sessionPeerIds) }()
      case 3: try { try decoder.decodeSingularStringField(value: &self._cid) }()
      default: break
      }
    }
  }
...
extension IMReportCommand: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularBoolField(value: &self._initiative) }()
...
extension IMPatchItem: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularInt64Field(value: &self._timestamp) }()
      case 4: try { try decoder.decodeSingularBoolField(value: &self._recall) }()
      case 5: try { try decoder.decodeSingularStringField(value: &self._data) }()
      case 6: try { try decoder.decodeSingularInt64Field(value: &self._patchTimestamp) }()
      case 7: try { try decoder.decodeSingularStringField(value: &self._from) }()
      case 8: try { try decoder.decodeSingularBytesField(value: &self._binaryMsg) }()
      case 9: try { try decoder.decodeSingularBoolField(value: &self._mentionAll) }()
      case 10: try { try decoder.decodeRepeatedStringField(value: &self.mentionPids) }()
      case 11: try { try decoder.decodeSingularInt64Field(value: &self._patchCode) }()
      case 12: try { try decoder.decodeSingularStringField(value: &self._patchReason) }()
      default: break
      }
    }
  }
...
extension IMPatchCommand: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeRepeatedMessageField(value: &self.patches) }()
      case 2: try { try decoder.decodeSingularInt64Field(value: &self._lastPatchTime) }()
      default: break
      }
    }
  }
...
extension IMPubsubCommand: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public var isInitialized: Bool {
    if let v = self._results, !v.isInitialized {return false}
    return true
  }
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 1: try { try decoder.decodeSingularStringField(value: &self._cid) }()
      case 2: try { try decoder.decodeRepeatedStringField(value: &self.cids) }()
      case 3: try { try decoder.decodeSingularStringField(value: &self._topic) }()
      case 4: try { try decoder.decodeSingularStringField(value: &self._subtopic) }()
      case 5: try { try decoder.decodeRepeatedStringField(value: &self.topics) }()
      case 6: try { try decoder.decodeRepeatedStringField(value: &self.subtopics) }()
      case 7: try { try decoder.decodeSingularMessageField(value: &self._results) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if let v = self._subtopic {
      try visitor.visitSingularStringField(value: v, fieldNumber: 4)
    }
    if !self.topics.isEmpty {
      try visitor.visitRepeatedStringField(value: self.topics, fieldNumber: 5)
    }
    if !self.subtopics.isEmpty {
      try visitor.visitRepeatedStringField(value: self.subtopics, fieldNumber: 6)
    }
  ...
  static func ==(lhs: IMPubsubCommand, rhs: IMPubsubCommand) -> Bool {
    ...
    if lhs._subtopic != rhs._subtopic {return false}
    if lhs.topics != rhs.topics {return false}
    if lhs.subtopics != rhs.subtopics {return false}
...
extension IMBlacklistCommand: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self._srcCid) }()
      case 2: try { try decoder.decodeRepeatedStringField(value: &self.toPids) }()
      case 3: try { try decoder.decodeSingularStringField(value: &self._srcPid) }()
      case 4: try { try decoder.decodeRepeatedStringField(value: &self.toCids) }()
      case 5: try { try decoder.decodeSingularInt32Field(value: &self._limit) }()
      case 6: try { try decoder.decodeSingularStringField(value: &self._next) }()
      case 8: try { try decoder.decodeRepeatedStringField(value: &self.blockedPids) }()
      case 9: try { try decoder.decodeRepeatedStringField(value: &self.blockedCids) }()
      case 10: try { try decoder.decodeRepeatedStringField(value: &self.allowedPids) }()
      case 11: try { try decoder.decodeRepeatedMessageField(value: &self.failedPids) }()
      case 12: try { try decoder.decodeSingularInt64Field(value: &self._t) }()
      case 13: try { try decoder.decodeSingularStringField(value: &self._n) }()
      case 14: try { try decoder.decodeSingularStringField(value: &self._s) }()
      default: break
      }
    }
  }
...
extension IMGenericCommand: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    117: .same(proto: "loggedinMessage"),
  ]
  ...
  fileprivate class _StorageClass {
    ...
    var _loginMessage: IMLoginCommand? = nil
    ...
    var _loggedinMessage: IMLoggedinCommand? = nil
    ...
    init(copying source: _StorageClass) {
      ...
      _loginMessage = source._loginMessage
      ...
      _loggedinMessage = source._loggedinMessage
    }
  }
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 2: try { try decoder.decodeSingularEnumField(value: &_storage._op) }()
        case 3: try { try decoder.decodeSingularStringField(value: &_storage._appID) }()
        case 4: try { try decoder.decodeSingularStringField(value: &_storage._peerID) }()
        case 5: try { try decoder.decodeSingularInt32Field(value: &_storage._i) }()
        case 6: try { try decoder.decodeSingularStringField(value: &_storage._installationID) }()
        case 7: try { try decoder.decodeSingularInt32Field(value: &_storage._priority) }()
        case 8: try { try decoder.decodeSingularInt32Field(value: &_storage._service) }()
        case 9: try { try decoder.decodeSingularInt64Field(value: &_storage._serverTs) }()
        case 10: try { try decoder.decodeSingularInt64Field(value: &_storage._clientTs) }()
        case 11: try { try decoder.decodeSingularInt32Field(value: &_storage._notificationType) }()
        case 100: try { try decoder.decodeSingularMessageField(value: &_storage._loginMessage) }()
        case 101: try { try decoder.decodeSingularMessageField(value: &_storage._dataMessage) }()
        case 102: try { try decoder.decodeSingularMessageField(value: &_storage._sessionMessage) }()
        case 103: try { try decoder.decodeSingularMessageField(value: &_storage._errorMessage) }()
        case 104: try { try decoder.decodeSingularMessageField(value: &_storage._directMessage) }()
        case 105: try { try decoder.decodeSingularMessageField(value: &_storage._ackMessage) }()
        case 106: try { try decoder.decodeSingularMessageField(value: &_storage._unreadMessage) }()
        case 107: try { try decoder.decodeSingularMessageField(value: &_storage._readMessage) }()
        case 108: try { try decoder.decodeSingularMessageField(value: &_storage._rcpMessage) }()
        case 109: try { try decoder.decodeSingularMessageField(value: &_storage._logsMessage) }()
        case 110: try { try decoder.decodeSingularMessageField(value: &_storage._convMessage) }()
        case 111: try { try decoder.decodeSingularMessageField(value: &_storage._roomMessage) }()
        case 112: try { try decoder.decodeSingularMessageField(value: &_storage._presenceMessage) }()
        case 113: try { try decoder.decodeSingularMessageField(value: &_storage._reportMessage) }()
        case 114: try { try decoder.decodeSingularMessageField(value: &_storage._patchMessage) }()
        case 115: try { try decoder.decodeSingularMessageField(value: &_storage._pubsubMessage) }()
        case 116: try { try decoder.decodeSingularMessageField(value: &_storage._blacklistMessage) }()
        case 117: try { try decoder.decodeSingularMessageField(value: &_storage._loggedinMessage) }()
        default: break
        }
      }
    }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if let v = _storage._loginMessage {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 100)
      }
      ...
      if let v = _storage._loggedinMessage {
  ...
  static func ==(lhs: IMGenericCommand, rhs: IMGenericCommand) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._loginMessage != rhs_storage._loginMessage {return false}
        ...
        if _storage._loggedinMessage != rhs_storage._loggedinMessage {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
